...
| 5 | Android shell (4 screens, nav, WebView) | 🟡 in progress (1/9) |
...
## 🟡 Phase 5 — Android shell (4 screens, nav, WebView) (1/9)
...
- 5.2: 4-section nav skeleton (NavHost with App/Chat/Shell/Settings; bottom bar)
- 5.3+: needs emulator or device for visual verification of UI
