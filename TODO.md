...
| 5 | Android shell (4 screens, nav, WebView) | 🟡 in progress (4/9) |
...
Tests: **102/102 backend + 21/21 Android unit** passing.
...
## 🟡 Phase 5 — Android shell (4 screens, nav, WebView) (4/9)
...
- 5.5–5.6: shell + settings screen bodies (placeholder-level now; real widgets in their own tasks)
