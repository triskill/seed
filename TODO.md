...
| 5 | Android shell (4 screens, nav, WebView) | 🟡 in progress (3/9) |
...
Tests: **102/102 backend + 13/13 Android unit** passing.
...
## 🟡 Phase 5 — Android shell (4 screens, nav, WebView) (3/9)
...
- 5.4–5.6: screen bodies (placeholder-level now; real widgets in their own tasks)
